...
INSERT INTO guest VALUES ('G1','John','Grey','0712345678','john@gmail.com','john_g','p6#3gk');
...
INSERT INTO guest VALUES ('G5','Alakhe','Mbibi','0623456789','alakhe@yahoo.com','alakhe_m','8opjj#k');
...
ALTER TABLE staff ADD PASSWORD VARCHAR2(255);
UPDATE staff SET PASSWORD = 'Alice2024'   WHERE STAFF_ID = 'S1';
UPDATE staff SET PASSWORD = 'Bob2024'     WHERE STAFF_ID = 'S2';
UPDATE staff SET PASSWORD = 'Carol2024'   WHERE STAFF_ID = 'S3';
UPDATE staff SET PASSWORD = 'Mandisi2024' WHERE STAFF_ID = 'S4';
UPDATE staff SET PASSWORD = 'Aisha2024'   WHERE STAFF_ID = 'S5';
UPDATE staff SET PASSWORD = 'David2024'   WHERE STAFF_ID = 'S6';
UPDATE staff SET PASSWORD = 'Sipho2024'   WHERE STAFF_ID = 'S7';
COMMIT;
